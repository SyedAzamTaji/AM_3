...
class PhaseThreeSetting extends StatelessWidget {
  // final String title;
              ...
              children: [
                ...
                Expanded(
                  child: SleekCircularSlider(
                    ...
                    min: 0,
                    max: 100,
                    initialValue: _mqttController.amp1.value.toDouble(),
                    onChange: null,
                    //  (double value) {
                    ...
                    innerWidget: (double value) => Center(
                      child: Container(
                        ...
                        child: Text(
                          "${_mqttController.amp1.value.toDouble().toStringAsFixed(0)} AMP",
                          style: TextStyle(
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Obx(
                () => Text(
                  "${_mqttController.amp3high.value.toDouble().toStringAsFixed(0)} AMP",
                  style: TextStyle(
        ...
        SliderTheme(
          ...
          child: Obx(
            () => Slider(
              value: _mqttController.amp3high.value.toDouble(),
              min: 0,
              max: 100,
              divisions: 100,
              onChanged: (double value) {
                _mqttController.updatePhase3lp(value);
              },
            ),
          ),
        ),
    ...
    return Column(
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              Obx(
                () => Text(
                  "${_mqttController.amp3low.value.toDouble().toStringAsFixed(0)} AMP",
                  style: TextStyle(
                    fontSize: Get.width * 0.04,
                    fontWeight: FontWeight.bold,
                    color: Colors.white,
        ...
        SliderTheme(
          ...
          child: Obx(
            () => Slider(
              value: _mqttController.amp3low.value.toDouble(),
              min: 0,
              max: 100,
              divisions: 100,
              onChanged: (double value) {
                _mqttController.updatePhase3hp(value);
              },
            ),
          ),
        ),
