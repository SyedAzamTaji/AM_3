          ...
          ElevatedButton(
            onPressed: () {
              if (_passwordController.text == "1234") {
                ...
                controller.isOilPressureVisible.value = !controller.isOilPressureVisible.value; // Show Oil Pressure widget
               
                Get.back(); 
              } else {
                Get.snackbar("Error", "Wrong Password!", backgroundColor: Colors.red);
              }
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
           ...
           GestureDetector(
            onLongPress: _showPasswordDialog, // Long press to enter password
              child: Obx(
                () => controller.isOilPressureVisible.value
                    ...
                    : Icon(Icons.lock, color: Colors.white, size: 40),) // Locked Icon
           ),
          ],
        ),
      ),
